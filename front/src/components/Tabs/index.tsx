import { User, Users, UsersFour, UsersThree } from 'phosphor-react';
import { useState } from 'react';
import UserType from '~/types/UserType';

const styles = {
  normalButton:
    'inline-flex p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300',
  activeButton:
    'inline-flex p-4 text-blue-600 rounded-t-lg border-b-2 border-blue-600 dark:text-blue-500 dark:border-blue-500',
  normalIcon:
